...
class _RecordsFilterPageState extends State<RecordsFilterPage> {
  ...
  List<WalletRecord> get filteredRecords {
    ...
    List<WalletRecord> records = List<WalletRecord>.from(recordService.records);
  ...
  Color _getWalletColor(String walletName) {
    final walletColors = {
      'Cashfile': const Color(0xFF8D6E63),
      'Cash': const Color(0xFF8D6E63),
      'BRI': Colors.blue,
      'Ajaib Stocks': Colors.blue,
      'Ajaib Kripto': Colors.purple,
      'Bibit': Colors.green,
      'SeaBank': Colors.orange,
      'BCA': Colors.blue,
      'Bibit Saham': Colors.grey,
      'Bibit Saham 2': Colors.orange,
      'Shopeepay': Colors.orange,
      'Permata': Colors.green,
      'MQ Sekuritas': Colors.orange,
      'Bareksa Gold': Colors.orange,
      'Bareksa RD': Colors.green,
      'Jago': Colors.orange,
      'Gopay': Colors.green,
      'DANA': Colors.lightBlue,
      'pluang': Colors.blue,
      'Gopay Coins': Colors.green,
    };

    return walletColors[walletName] ?? Colors.grey;
  }
